...
# Proves to the MCP Registry that this image belongs to the server of that name.
LABEL io.modelcontextprotocol.server.name="io.github.ravibagri5/crossplane-mcp-server"
